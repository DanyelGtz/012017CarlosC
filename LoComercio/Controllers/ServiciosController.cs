...
namespace LoComercio.Controllers
{
    public class ServiciosController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,IdTipoServicio,Nombre,Precio")] Servicio servicio)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(long id, [Bind("Id,IdTipoServicio,Nombre,Precio")] Servicio servicio)
        {
            if (id != servicio.Id)
            {
                return NotFound();
